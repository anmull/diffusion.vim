" Diffusion color file
"
" Modified version of `benlight` by Ben Kreeger (@kreeger)
" https://github.com/kreeger/benlight
"
" Converted from Textmate theme Twilight using Coloration v0.3.2
...
hi LineNr                       ctermfg=245  ctermbg=235  cterm=NONE         guifg=#868686 guibg=#141414 gui=NONE
...
hi CursorLineNR                 ctermfg=179  ctermbg=NONE cterm=NONE         guifg=#8f9d6a guibg=#3C3836 gui=NONE  guisp=#222E30

hi StatusLine                   ctermfg=231  ctermbg=240  cterm=NONE         guifg=#cda869 guibg=#222222 gui=NONE
"hi StatusLineNC                ctermfg=231  ctermbg=240  cterm=NONE         guifg=#cda869 guibg=#222222 gui=NONE

hi ExtraWhitespace              ctermfg=NONE ctermbg=167  cterm=NONE         guifg=NONE    guibg=#cf6a4c gui=NONE
hi ShowTrailingWhitespace       ctermfg=NONE ctermbg=167  cterm=NONE         guifg=NONE    guibg=#cf6a4c gui=NONE
hi BadWhitespace                ctermfg=NONE ctermbg=167  cterm=NONE         guifg=NONE    guibg=#cf6a4c gui=NONE
hi ExceedsTextWidth             ctermfg=NONE ctermbg=167  cterm=NONE         guifg=#141414 guibg=#912C00 gui=NONE
...
hi ErrorMsg                     ctermfg=NONE ctermbg=167  cterm=NONE         guifg=#141414 guibg=#cf6a4c gui=NONE
